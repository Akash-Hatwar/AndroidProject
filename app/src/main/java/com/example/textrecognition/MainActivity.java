...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognizedTextFromImage() {
        ...
        progressDialog.setMessage("Preperaing image....");
        progressDialog.show();
            ...
            Task<Text> textTaskResult = textRecognizer.process(inputImage)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(MainActivity.this,"Fail recognized text due to"+e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    private void pickImagGallery() {
        Log.d(TAG, "pickImagGallery: ");
